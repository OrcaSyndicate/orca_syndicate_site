...
df_tb = load_data('https://raw.githubusercontent.com/OrcaSyndicate/orca_syndicate_site/main/OrcaSyndicate/site_documents/mlb_prop_data_website.xlsx', sheet_name=0)
