...
st.subheader('Model Performance Summary')
st.image('https://github.com/OrcaSyndicate/orca_syndicate_site/blob/main/OrcaSyndicate/site_images/mlb_prop_r_summary.PNG?raw=true')
st.write('')
st.subheader('All Test Datapoints')
df_r = load_data('https://github.com/OrcaSyndicate/orca_syndicate_site/raw/refs/heads/main/OrcaSyndicate/site_documents/mlb_prop_data_website.xlsx', sheet_name=1)
...
st.subheader('Model Performance Summary')
st.image('https://github.com/OrcaSyndicate/orca_syndicate_site/blob/main/OrcaSyndicate/site_images/mlb_prop_k_summary.PNG?raw=true')
st.write('')
st.subheader('All Test Datapoints')
df_k = load_data('https://github.com/OrcaSyndicate/orca_syndicate_site/raw/refs/heads/main/OrcaSyndicate/site_documents/mlb_prop_data_website.xlsx', sheet_name=2)
...
st.subheader('Model Performance Summary')
st.image('https://github.com/OrcaSyndicate/orca_syndicate_site/blob/main/OrcaSyndicate/site_images/mlb_prop_er_summary.PNG?raw=true')
st.write('')
st.subheader('All Test Datapoints')  
df_er = load_data('https://github.com/OrcaSyndicate/orca_syndicate_site/raw/refs/heads/main/OrcaSyndicate/site_documents/mlb_prop_data_website.xlsx', sheet_name=3)
