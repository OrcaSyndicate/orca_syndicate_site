...
data_comb1 = load_data('site_documents/nba_data_website.xlsx', sheet_name=11)
...
st.image('site_images/nba_player_spreads_summary.png')
st.write('')
st.subheader('All Player-Level Model Spread Datapoints')
data_comb2 = load_data('site_documents/nba_data_website.xlsx', sheet_name=12)
...
st.image('site_images/nba_player_ou_summary.png')
st.write('')
st.subheader('All Player-Level Model O/U Datapoints')
data_comb3 = load_data('site_documents/nba_data_website.xlsx', sheet_name=13)
